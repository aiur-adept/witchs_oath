...
NOBLE_DEFS: dict[str, dict] = {
    ...
    "sndrr_incantation":   {"cost": 3, "name": "Sndrr, Noble of Incantation", "activated_verb": VERB_SEEK,    "activated_value": 1},
    "indrr_incantation":   {"cost": 3, "name": "Indrr, Noble of Incantation", "activated_verb": VERB_INSIGHT, "activated_value": 2},
    "bndrr_incantation":   {"cost": 3, "name": "Bndrr, Noble of Incantation", "activated_verb": VERB_BURN,    "activated_value": 1},
    "wndrr_incantation":   {"cost": 3, "name": "Wndrr, Noble of Incantation", "activated_verb": VERB_WOE,     "activated_value": 2},
